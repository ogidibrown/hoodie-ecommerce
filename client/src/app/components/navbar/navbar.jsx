    ...
    <nav className='bg-[#ff6700] py-1 md:py-2 px-2 md:px-[100px] '>
        ...
        <div className='flex justify-between items-center'>
            ...
            <div className='flex  items-center'>
                <div className='flex items-center'>
                    <BsPerson className='text-white w-7 h-7 md:w-[30px] md:h-[30px] ' />
                    <FaShoppingCart className='text-white h-7 w-[30px] md:w-[30px] md:h-[30px] ' />
                </div>
                <div className='bg-white rounded-[50%] w-4 h-4 absolute ml-[45px] mb-[22px] md:ml-[55px] md:mb-[25px] text-center text-[#111] text-[11px] md:text-[12px]'>
                    0
                </div>
            </div>
