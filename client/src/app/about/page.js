    ...
    <div className='mx-[20px] mb-[30px]'>
        <div className='w-full relative h-[800px]'>
            ...
            <div className='grid grid-cols-2 place-items-center gap-1 md:grid-cols-3 '>
                <div className='flex flex-col m-3 rounded-[4px] border-[#0F8649] border-2 h-[480px]'>
                ...
                <Image src={AboutImg} alt='about image' width={300} height={300} className='object-cover'  /> 
                <Image src={AboutImg} alt='about image' width={300} height={300} className='object-cover md:flex hidden'  />
            </div>
